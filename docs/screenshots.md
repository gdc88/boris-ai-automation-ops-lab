...
![Sanitized Telegram operations report mock](assets/telegram-report-mock.svg)
...
![Visible browser QA contact sheet mock](assets/visible-browser-qa-contact-sheet.svg)
...
![Sanitized job tracker workflow mock](assets/job-tracker-workflow-mock.svg)
...
![Sanitized service health dashboard mock](assets/service-health-dashboard-mock.svg)
